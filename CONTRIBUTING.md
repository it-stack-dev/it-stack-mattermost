# Contributing to IT-Stack MATTERMOST
...
- This is **Module 07** in the IT-Stack platform
- All changes must preserve the 6-lab testing progression
- Lab 07-01 (Standalone) must always work without external dependencies
- Test with make test-lab-01 before submitting a PR

## Development Setup

```bash
git clone https://github.com/it-stack-dev/it-stack-mattermost.git
